...
function requireAuth(redirectTo = 'index.html') {
  ...
  // Align session.userId with local database ID if it was changed by sync
  if (session.role === 'user' && typeof getUserById === 'function' && typeof getUserByEmail === 'function') {
